...
var SBG = { todo:'rgba(107,125,179,.2)',inprog:'rgba(79,142,247,.2)',hold:'rgba(160,110,232,.2)',review:'rgba(245,166,35,.2)',done:'rgba(46,204,143,.2)',overdue:'rgba(247,95,95,.2)' };
var SFG = { todo:'#8fa0cc',inprog:'var(--accent3)',hold:'#b88cf0',review:'var(--gold)',done:'var(--green)',overdue:'var(--red)' };
